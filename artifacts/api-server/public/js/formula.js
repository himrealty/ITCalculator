...
function getNewRegimeSlabs() {
    return taxFormulas?.new_regime_slabs || getFallbackFormulas().new_regime_slabs;
}

function getOldRegimeSlabs() {
    return taxFormulas?.old_regime_slabs || getFallbackFormulas().old_regime_slabs;
}

function getDeductionLimit(section) {
    return taxFormulas?.deductions?.[section] || getFallbackFormulas().deductions[section];
}
